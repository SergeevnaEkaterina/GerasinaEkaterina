...
public class Board {
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(this.descData, rhs.descData) && Objects.equals(this.pinned, rhs.pinned)
                && Objects.equals(this.shortUrl, rhs.shortUrl)
                && Objects.equals(this.idEnterprise, rhs.idEnterprise) && Objects.equals(this.name, rhs.name)
